<x-jet-action-section>
    ...
    <x-slot name="description">
        {{ __('Administra tus sesiones activas.') }}
    </x-slot>

    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            {{ __('Si es necesario puedes cerrar las sesiones desde este ordenador.') }}
        </div>
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            <x-slot name="title">
                {{ __('Cerrar sesión de otros ordenadores') }}
            </x-slot>

            <x-slot name="content">
                {{ __('Por favor ingrese su contraseña para confirmar.') }}
